...
public class ImageController {
    ...
    private static String invalidUserEditError = "Only the owner of the image can edit the image";
    private static String invalidUserDeleteError = "Only the owner of the image can delete the image";
